                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Charterer</h4>
                                    <div class="pull-right">
<a href="<?= site_url("home/dashboard") ?>"><button class="btn btn-success">Save</button></a>
<a href="<?= site_url("home/dashboard") ?>"><button class="btn">Close</button></a>
</div>
                                </div>
                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add New</h4>
                                    
                                         
                                        <div class="form-group">
                                            <label class="col-form-label">Select Role</label>
                                            <select class="custom-select">
                                                <option selected="selected">Charterer</option>
                                                <option value="1">Owner</option>
                                                <option value="2">Charterer Broker</option>
                                                <option value="3">Owner Broker</option>
                                            </select>
                                        </div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body row">
                                        <h4 class="header-title wrapper">Charterer</h4>
                                        <div class="form-group col-md-6">
                                            <label for="example-text-input" class="col-form-label">Type Of Vendor</label>
                                            <input class="form-control" type="text" id="example-text-input">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Name Of the Organisation</label>
                                            ...
                                            <label for="example-search-input" class="col-form-label">Address for Communication</label>
                                            <input class="form-control" id="example-search-input">
                                        </div>                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Name Of Contact Person</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Designation of Contact Person</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Phone No.</label>
                                            <input class="form-control" type="number">
                                        </div>                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Fax No.</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>                                        <div class="form-group col-md-6">
                                            <label for="example-search-input" class="col-form-label">Mobile</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>                                        <div class="form-group col-md-12">
                                            <label for="example-search-input" class="col-form-label">Email ID</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>                                                                          <div class="form-group col-md-12">
                                            <label for="example-search-input" class="col-form-label">Permanent Account Number (PAN)</label>
                                            <input class="form-control" type="search" id="example-search-input">
                                        </div>
                                    </div>
                                </div>
