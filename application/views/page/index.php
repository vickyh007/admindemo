                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                  ...
                                  <a href="<?= site_url("home/add_charterer") ?>"> <button class="btn btn-primary"><i class="fa  fa-angle-left mr-1"></i>Add New</button></a>
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            <tr class="heading-td">
                                                <td class="mv-icon">Type Of Vendor</td>
                                                <td class="coin-name">Name of Organisation</td>
                                                <td class="buy">Name Of Contact Person</td>
                                                <td class="sell">Mobile</td>
                                            ...
                                            <tr>
                                                ...
                                                <td >Echer Shiping services</td>
                                                <td>Arron Stone</td>
                                                <td>8967675656</td>
                                                <td class="text-center">
                                 <a href="#" class="
                                 mr-2"><i class="fa fa-eye text-dark"></i></a>
                                 <a href="#"  class="
                                 mr-2"><i class="fa fa-edit text-dark"></i></a>
                                 <a href="#"  class="
                                 mr-2"><i class="fa fa-close text-dark"></i></a>
                                                </td>
                                            </tr>
                                                                                        <tr>
                                                <td>Hello World
