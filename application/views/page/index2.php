                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Vessels</h4>
                                  <a href="<?= site_url("home/add_vessels") ?>"> <button class="btn btn-primary"><i class="fa  fa-angle-left mr-1"></i>Add New</button></a>
                                </div>
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            <tr class="heading-td">
                                                <td class="mv-icon">Vessel Name</td>
                                                <td class="coin-name">IMO Number</td>
                                                <td class="buy">Class</td>
                                                <td class="sell">Owner</td>
