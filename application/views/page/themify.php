        ...
        <div class="main-content">
					...
					<div class="row align-items-center">
						<div class="col-sm-12">
							<div class="breadcrumbs-area clearfix">
								<h4 class="page-title pull-left">Themify</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <!-- arrow & direction icon end -->
                    <!-- WEB icon start -->
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">WEB APP ICONS</h4>
                                <div class="icon-section">
                                    <div class="icon-container">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">CONTROL ICONS</h4>
                                <div class="icon-section">
                                    <div class="icon-container">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">TEXT EDITOR</h4>
                                <div class="icon-section">
                                    <div class="icon-container">
                                        <span class="ti-control-stop"></span><span class="icon-name"> ti-control-stop</span>
                                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">LAYOUT ICONS</h4>
                                <div class="icon-section">
                                    <div class="icon-container">
