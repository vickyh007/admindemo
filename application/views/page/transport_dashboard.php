                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Responsible User</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                       ...
                                       <input class="form-control" type="text" id="example-text-input">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label class="col-form-label">Date Min</label>
                                        <input class="form-control" type="date" value="" id="example-date-input">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="col-form-label">Date Max</label>
                                       <input class="form-control" type="date" value="" id="example-date-input">
                                        </div>
                                              <div class="form-group col-md-8">
                                                   <div class="wrapper">Vessel Type</div>
                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Small Bulk</label>
                                            </div>
                                                 <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Handysize</label>
                                            </div>
                                                 <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Supramax</label>
                                            </div>
                                                 <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Panamax</label>
                                            </div>
                                                 <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Post-Panamax</label>
                                            </div>
                                                 <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" checked="" class="custom-control-input" id="customCheck1">
                                                <label class="custom-control-label" for="customCheck1">Cape Size</label>
                                            </div>
                                        </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="col-12 mt-3">
                                <div class="card">
                                    <div class="card-body row">
                                        <h4 class="header-title wrapper">Bookmarked fixture<div class="pull-right">
Total Items: 0
</div></h4>
                                      <div class="market-status-table mt-3 wrapper">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            <tbody><tr class="heading-td">
                                                <th class="mv-icon">ID</th>
                                                <th class="coin-name">Status</th>
                                                <th class="buy">Date</th>
                                                <th class="sell">Vessel</th>
                                                <th class="trends">Charterer</th>
                           ...
                           <!-- Textual inputs start -->
                                   <h3 class="header-title col-md-12 mt-5">Progress Report<div class="pull-right">
<a href="#"><button class="btn btn-primary">Legend</button></a>
<a href="#"><button class="btn">Edit</button></a>
                            ...
                            <div class="col-12 mt-3">
                                <div class="card">
                                    <div class="card-body row">
                                        <h4 class="header-title wrapper">Bookmark Fixture<div class="pull-right">
Total Items: 0
</div></h4>
                                      <div class="market-status-table mt-3 wrapper">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            <tbody><tr class="heading-td">
                                                <th class="mv-icon">ID</th>
                                                <th class="coin-name">Progress</th>
                                                <th class="buy">Color</th>
                                                <th class="sell">CP Date</th>
                                                <th class="trends">Charterer</th>                                                <th class="trends">Owner</th>                                                <th class="trends">Vessel</th>
